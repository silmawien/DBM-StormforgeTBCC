...
local specWarnSpark     = mod:NewSpecialWarningYou(21027, nil, nil, nil, 1, 2)
local yellSpark			= mod:NewYell(21027)

local specWarnCurse     = mod:NewSpecialWarningYou(45032, nil, nil, nil, 3, 2)
...
function mod:SPELL_AURA_REMOVED(args)
	if args.spellId == 45032 and args:IsPlayer() then
		specWarnCurse:Show()
	end
end
